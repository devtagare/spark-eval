 ...
 * <hostname> <port> <checkpoint-directory> <output-file> <hostname> and
 * <port> describe the TCP server that Spark Streaming would connect to receive
 * data. <checkpoint-directory> directory to HDFS-compatible file system which
 ...
 */
public final class RecoverableFileWordCount
{
